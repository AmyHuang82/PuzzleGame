...
class App extends React.Component {
  ...
  exchangeNumber(index, e) {
    ...
    if (result) {
      const playerList = JSON.parse(localStorage.getItem('player')) || [];
      // 判斷排名
      ...
      const playRecord = { name, rank, moves };
  ...
  render() {
    return (
      <div>
        <PlayerInput
          shuffleNumber={this.shuffleNumber.bind(this)}
          playerNameInput={this.playerNameInput.bind(this)}
